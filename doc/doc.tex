...
\section{Quiz otázky}
    ...
    \subsection{8. přednáška - SW solution for city information kiosks Part 3}
        ...
        \subsubsection{Product delivery \cite{osma}}
    ...
    \subsection{9. přednáška - SW solution for city information kiosks Part 4 \cite{devatab}}


        \subsubsection{Transition and closure \cite{devataa}}
